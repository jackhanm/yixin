...
#import "UMSocial.h"
@interface healBook ()<WKNavigationDelegate,WKUIDelegate,UMSocialUIDelegate>
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) UIProgressView *progressView;
@property (nonatomic, copy)NSString *str;
@end

@implementation healBook
- (void)viewWillAppear:(BOOL)animated
{
    [super viewWillAppear:animated];
    [MobClick beginLogPageView:@"Pagefour"];//("PageOne"为页面名称，可自定义)
}
...
//    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"健康书籍";
...
- (void)createview
{
    ...
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.yixinw.cn:8881/sdown/"]]];
    [self.view addSubview:self.webView];
